    ...
    public function safeUp()
    {
        ...
        try {
            $this->createTable($i18n->sourceMessageTable, [
                'id'        => Schema::TYPE_PK,
                'hash'      => Schema::TYPE_STRING  . '(32) DEFAULT ""',
            ...
            if ( strstr($e->getMessage(), 'already exists') ) {
                $this->addColumn($i18n->sourceMessageTable, 'hash', Schema::TYPE_STRING  . '(32) DEFAULT ""');
        ...
        try {
            ...
            if ( strstr($e->getMessage(), 'already exists') ) {
                $this->addColumn($i18n->messageTable, 'hash', Schema::TYPE_STRING  . '(32) DEFAULT ""');
            }
        }
    }
